...
public class EntityShader extends ShaderProgram {
	...
	public static final String VERTEX_FILE = "src/Shader/vertexShader.txt";
	public static final String FRAGEMENT_FILE = "src/Shader/fragementShader.txt";
	public static final String GEOMETRY_FILE = "src/Shader/geometryShader.txt";
	...
	protected void bindAttributes() {
		...
		super.bindAttribute(1, "texturecoords");//binds VAO attribute texturecoords to texturecoords variable in vertexShader program
	}
